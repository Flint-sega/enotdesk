...
Тесты: `npm test` (84 теста: серверные HTTP/WS + client-швы). Инъекция ввода в ОС тестами не выполняется — проверяются загрузка адаптера, валидация и координаты; реальную инъекцию проверяет человек.

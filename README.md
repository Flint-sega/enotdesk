...
Запустите два окна приложения: для собранного `EnotDesk.app` — `open -n EnotDesk.app`, для исходников — второй `npm start` из другого терминала. В первом окне нажмите «Получить помощь» и скопируйте ID с паролем, во втором войдите как специалист и подключитесь по этим ID и паролю. Одно окно EnotDesk работает только в одной роли: смена роли в том же окне завершает текущий сеанс, поэтому обе роли — всегда два окна.

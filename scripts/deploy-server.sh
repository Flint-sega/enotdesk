...
for f in server assets package.json package-lock.json scripts/install-server.sh client/lib/i18n.mjs client/locales; do
...
info "собираю tarball (server/, assets/, client/lib/i18n.mjs, client/locales/, package.json, package-lock.json, scripts/install-server.sh)"
tar -czf "$TMP/app.tar.gz" -C "$ROOT" server assets package.json package-lock.json scripts/install-server.sh client/lib/i18n.mjs client/locales

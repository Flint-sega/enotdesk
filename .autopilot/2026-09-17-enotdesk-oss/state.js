window.STATE =
{
  ...
  "updatedAt": "2026-09-17T18:55:23+03:00",
  ...
  "tickets": [
    ...
    },
    {
      ...
      "startedAt": "2026-09-17T15:00:12+03:00",
      "finishedAt": "2026-09-17T15:24:46+03:00",
      "commit": "89f5dca + ремонт 99d5dd3",
      "tests": {
        "passed": 198,
        "failed": 0
      },
      "repairFindings": [
        "релиз v0.1.0 опубликован: 3 артефакта + checksums + фиды; CI-флейк ETag-теста (undici strict, ubuntu24) закрыт детерминизмом Connection: close"
      ]
    },
    {
      "id": "10",
  ...
  "concerns": [
    ...
    "информационально: Range-тест остался на keep-alive — поверхность undici-флейка частично сохранена (craft, рерью ETag-ремонта)"
  ],
  "reviewers": {
